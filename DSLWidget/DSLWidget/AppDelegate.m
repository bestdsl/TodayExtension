...
- (BOOL)application:(UIApplication *)app openURL:(NSURL *)url options:(NSDictionary<UIApplicationOpenURLOptionsKey,id> *)options
{
    ...
    if ([url.absoluteString hasPrefix:@"DSLTodayWidget"]) {
        if ([url.host isEqualToString:@"SecondVC"]) {
            ...
            [rootNav presentViewController:[[SecondVC alloc]init] animated:YES completion:nil];
        }
    }
